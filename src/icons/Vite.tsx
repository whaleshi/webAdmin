...
const Vite = (props: SVGProps<SVGSVGElement>) => {
  const id = useId()
  const mask0 = `${id}-vite__mask0`
  const f0 = `${id}-vite__filter0_f`
  const f1 = `${id}-vite__filter1_f`
  const f2 = `${id}-vite__filter2_f`
  const f3 = `${id}-vite__filter3_f`
  const f4 = `${id}-vite__filter4_f`
  const f5 = `${id}-vite__filter5_f`
  const f6 = `${id}-vite__filter6_f`
  const f7 = `${id}-vite__filter7_f`
  const f8 = `${id}-vite__filter8_f`
  const f9 = `${id}-vite__filter9_f`
  const f10 = `${id}-vite__filter10_f`
  const f11 = `${id}-vite__filter11_f`
  const f12 = `${id}-vite__filter12_f`
  const f13 = `${id}-vite__filter13_f`
  const f14 = `${id}-vite__filter14_f`
