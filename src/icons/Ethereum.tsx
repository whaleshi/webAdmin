...
const Ethereum = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id={ethC} x1="50%" x2="50%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#FFF" stopOpacity={0.5} />
          <stop offset="100%" stopOpacity={0.5} />
        </linearGradient>
        <circle id={ethB} cx="16" cy="15" r="15" />
        <filter
          id={ethA}
          width="111.7%"
          height="111.7%"
      ...
      <g fill="none" fillRule="evenodd">
        <use fill="#000" filter={`url(#${ethA})`} xlinkHref={`#${ethB}`} />
        <use fill="#627EEA" xlinkHref={`#${ethB}`} />
        <use
          fill={`url(#${ethC})`}
        ...
        <g fillRule="nonzero">
          <use fill="#000" filter={`url(#${ethD})`} xlinkHref={`#${ethE}`} />
          <use fill="#FFF" fillOpacity={0} fillRule="evenodd" xlinkHref={`#${ethE}`} />
        </g>
